...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			adressbook.Table:        adressbook.ValidColumn,
			balances.Table:          balances.ValidColumn,
			delegates.Table:         delegates.ValidColumn,
			invoice.Table:           invoice.ValidColumn,
			invoices_payments.Table: invoices_payments.ValidColumn,
			privatekeys.Table:       privatekeys.ValidColumn,
			recentinvoices.Table:    recentinvoices.ValidColumn,
			rewardsdata.Table:       rewardsdata.ValidColumn,
			settings.Table:          settings.ValidColumn,
			swaps.Table:             swaps.ValidColumn,
			task.Table:              task.ValidColumn,
			transfers.Table:         transfers.ValidColumn,
			undelegates.Table:       undelegates.ValidColumn,
			user.Table:              user.ValidColumn,
			userstate.Table:         userstate.ValidColumn,
